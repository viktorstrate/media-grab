(function(modules) {
  ...
  const bgpage = webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].extension.getBackgroundPage();
  const bgFuncs = {
    tabMedia: bgpage.tabMedia,
    downloadMedia: bgpage.downloadMedia
  };
  console.log("Popup script background", webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].extension.getBackgroundPage());
  console.log("Popup window", window);
  webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].tabs.query({
    active: true,
    currentWindow: true
  }).then(tabs => {
